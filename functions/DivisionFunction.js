...
class DivisionFunction extends Computable_1.default {
    constructor(match) {
        super(match);
    }
    evaluate(args) {
...
DivisionFunction.matchExpression = /D/g;
DivisionFunction.precedence = 1;
DivisionFunction.numParameters = 2;
exports.default = DivisionFunction;
